...
parser.add_argument('--network_dir', default="/usr1/home/ytsvetko/projects/mnlm/work/mlbl_b_orig")
...
def main():
  ...
  network = mplm.MNLM(symbol_table.Size(), args.vector_size, args.ngram_order-1,
